...
function( compile_pyx _name generated_file )
  ...
  #set_source_files_properties( ${_generated_file} PROPERTIES COMPILE_FLAGS "-DCYTHON_LIMITED_API=1 -DPy_LIMITED_API=0x030B0000")
...
function( cython_add_module _name )
  ...
  #target_compile_definitions(${_name} PUBLIC -DPy_LIMITED_API=0x030B0000)
  #target_compile_definitions(${_name} PUBLIC -DCYTHON_LIMITED_API=1)
  set_target_properties(${_name} PROPERTIES SUFFIX .abi3.so)
  if( APPLE )
