...
cdef extern from "<model_server/lib/api/client_base_types.hpp>" namespace "turi":
    cdef cppclass variant_type:
        ...
        variant_type& set_xframe "operator=<std::shared_ptr<turi::unity_xframe_base>>"(const unity_xframe_base_ptr& other)
    ...
    unity_xframe_base_ptr& variant_get_xframe "turi::variant_get_ref<std::shared_ptr<turi::unity_xframe_base>>" (variant_type& v)
    ...
    const unity_xframe_base_ptr& variant_get_xframe "turi::variant_get_ref<std::shared_ptr<turi::unity_xframe_base>>" (const variant_type& v)
    ...
    void variant_set_xframe "turi::variant_set_value<std::shared_ptr<turi::unity_xframe_base>>" (variant_type& v, unity_xframe_base_ptr& f)
