...
class DecisionTreeRegressionTest(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertRaises(
            ToolkitError,
            lambda: tc.decision_tree_regression.create(
...
def test_suite_decision_tree_classifier():
    ...
    for t in testCases:
        ...
        testcase_class = type(
            "DecisionTreeClassifierTest_%s" % t.__name__,
...
def binary_classification_integer_target(cls):
    ...
    cls.model = tc.decision_tree_classifier.create(
...
class DecisionTreeClassifierTest(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertRaises(
            ToolkitError,
            lambda: tc.decision_tree_classifier.create(
                self.dtrain, target="label_wrong", **self.param
            ),
        )
