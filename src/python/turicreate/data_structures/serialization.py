...
# XFrames require a disk-backed file or directory to work with.  This directory 
# has to be present to allow for serialization or deserialization. 
__serialization_directory = None 
from sys import version_info as _version_info


def enable_xframe_serialization(serialization_directory):
    """
    Enables pickling of XFrames through the use of a user-set directory to 
    ...
    When an XFrame is pickled, a copy of the XFrame is saved in this
    ...
    if _version_info[0] == 2:
        raise RuntimeError("XFrame serialization not supported in python 2.")
...
def _safe_serialization_directory():
    ...
    if __serialization_directory is None:
        ...
        raise expected_error("Serialization directory not set to enable pickling or unpickling. "
            "Set using turicreate.data_structures.serialization.enable_xframe_serialization().")
