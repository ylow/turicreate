...
latex_documents = [
    ("index", "TuriCreate.tex", u"Turi Create Documentation", u"Turi", "manual"),
]
...
man_pages = [("index", "turicreate", u"Turi Create Documentation", [u"Turi"], 1)]
