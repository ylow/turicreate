...
/*rec*/   {0,  0,  1,  0,  1,  0,  0,  0,  0, 0},  // recursive casts to string and self.
...
/*img*/   {0,  0,  1,  1,  0,  0,  0,  0,  1, 0},  // img casts to string, vec, and self.
/*ndvec*/ {0,  0,  1,  1,  0,  0,  0,  0,  0, 1}}; // ndvec casts to str and flattens to vec
