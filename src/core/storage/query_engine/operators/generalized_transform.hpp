 ...
 */
#ifndef TURI_XFRAME_QUERY_MANAGER_GENERALIZED_TRANSFORM_HPP
#define TURI_XFRAME_QUERY_MANAGER_GENERALIZED_TRANSFORM_HPP
...
typedef std::function<void (const xframe_rows::row&,
                            xframe_rows::row&)> generalized_transform_type;
