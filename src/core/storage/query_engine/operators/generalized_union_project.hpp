 ...
 */
#ifndef TURI_XFRAME_QUERY_MANAGER_GENERALIZED_UNION_PROJECT_NODE_HPP
#define TURI_XFRAME_QUERY_MANAGER_GENERALIZED_UNION_PROJECT_NODE_HPP
...
struct operator_impl<planner_node_type::GENERALIZED_UNION_PROJECT_NODE> : public query_operator {
 public:
  ...
  std::vector<std::shared_ptr<const xframe_rows> > input_v;
...
#endif // TURI_XFRAME_QUERY_MANAGER_UNION_HPP
