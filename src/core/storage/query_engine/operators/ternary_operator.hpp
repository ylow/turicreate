 ...
 */
#ifndef TURI_XFRAME_QUERY_MANAGER_TERNARY_OPERATOR_HPP
#define TURI_XFRAME_QUERY_MANAGER_TERNARY_OPERATOR_HPP
...
#endif // TURI_XFRAME_QUERY_MANAGER_TERNARY_OPERATOR_HPP
